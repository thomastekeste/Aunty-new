...
export default function TimeAvailableScreen({ navigation }: Props) {
  ...
  return (
    <ConsultationShell
      ...
      totalSteps={18}
      auntyId="4"
      phaseBadge="Fatou's Reality Check · Technician"
      auntyMessage="Ma chérie, I am not building you a routine you will abandon in one week. Be honest with me. How much time can you truly give on wash day?"
      ...
      footer={
        <Button
          ...
          onPress={() => {
            if (selected) {
              setData({ time_available: selected });
